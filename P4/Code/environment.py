...
class Environment(object):
    ...
    def reset(self):
        ...
        print "alpha = {}, gamma = {}, eplison = {}".format(self.primary_agent.alpha,self.primary_agent.gamma,self.primary_agent.eplison)
    ...
    def step(self):
        ...
        if self.primary_agent is not None:
            ...
            if agent_deadline <= self.hard_time_limit:
                ...
                self.finalscore = self.primary_agent.score
